# Rettig-DA-First-Draft-Final
This repository includes all files related to the first draft section of the final project for Will Rettig in DA401.
...
# Reproducing Code
Clone/download repo
Open FirstDraftData.rmd in RStudio
Ensure CSVs are in the same directory
Install applicable packages
Run all code chunks sequentially
Read code comments where available
